    ...
    <div class="col-md-5 rounded bg-light text-dark p-2">
        ...
        <table class="w-100">
            <form action="/login-submit" method="post">
                ...
                <tr>
                    <th>Name</th>
                    <td><input type="text" class="form-control border-2 border-dark"></td>
                </tr>
                <tr>
                    <th>Password</th>
                    <td>
                        <div class="input-group">
                            <input type="password" id="input" class="form-control border-2 border-dark" style="border-right: none">
                ...
                <tr>
                    <td colspan="2" class="text-center"><span>Don't have an account? <a href="/register">register</a></span></td>
                </tr>
            </form>
        </table>
    </div>
